...
def run_test_sum_more_cosines():
    ...
    # Test 2:
    expected = -0.39980  # This is APPROXIMATELY the correct answer.
    ...
    # Test 3:
    expected = 0.12415  # This is APPROXIMATELY the correct answer.
